...
class Time(commands.Cog):
    ...
    @commands.command(aliases=['timeinAmerica'], help="This command will output time in America for the following cities: " + str_cities)
    ...
    @commands.command(aliases=['timeinAsia'], help="This command will output time in Asia for the following cities: " + str_cities2 + str_cities3 + str_cities4)
